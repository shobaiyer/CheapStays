...
<table background="images/h7.jpg" id="tab" >
	...
	<tr>
		...
		<td style="width:400px;height: 600px;text-align: center; " valign="top"> 
				...
				<tr>
					<th>
						<h1 style="color:purple;">Delete Room</h1>
					</th>
				</tr>
 <tr> 
 <td valign="top">
 <div  id="regis"> 
        	<c:url var="myAction" value="delRoom.obj" /> 
        	
         	<form method="post" modelAttribute="room" action="${myAction}" style="cursor:url('images/88.cur'),default" onsubmit="return delvali()" name="frm1">
        	<table align="center" >
        	<tr><td colspan="2" valign="top"><input type="text" name="error" id="errortxt"
        	       value="Enter the Room Id" style="cursor:url('images/88.cur'),default"/></td></tr>
           ...
           <tr>
           	...
           	<td>
           		<input id="txt" name="roomId" placeholder="  Room Id Here"/><br/>
           		
           	</td>
           </tr>
            <tr>
                <td colspan="2" align='right'>
                    <br><input type="submit" name="action" value="deleteRoom" id="sbmt" class='button' style="cursor:url('images/88.cur'),default" />
                </td>
