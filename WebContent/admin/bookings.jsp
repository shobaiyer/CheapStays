...
<table background="images/h7.jpg" id="tab">
	...
	<tr>
		...
		<td style="width:400px;height: 600px;text-align: center; " valign="top"> 
				...
				<tr>
					<th>
						<h1 style="color:purple;">Show Date Based Bookings</h1>
					</th>
				</tr>
 <tr> 
 <td valign="top">
 <div  id="regis"> 
        <c:url var="myAction" value="showDateBookings.obj" /> 
        	
         	<form:form method="post" modelAttribute="booking" action="${myAction}" cssStyle="cursor:url('images/88.cur'),default">
        	<table align="center" >
        	<tr><td colspan="2" ><input type="text" name="error" id="errortxt"
        	       value="Enter the Booking from date" style="cursor:url('../\images/88.cur'),default"/></td></tr>
           ...
           <tr>
           	...
           	<td>
           		<form:input type="date" path="bookedFromDate"/>
           	</td>
           </tr>
            <tr>
                <td colspan="2" align='right'>
                    <br><input type="submit" name="action" value="showBooking"  id="sbmt" class='button' style="cursor:url('../\images/88.cur'),default" />
                </td>
