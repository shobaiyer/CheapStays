...
<table background="images/h7.jpg" id="tab">
	...
	<tr>
		...
		<td style="width:400px;height: 600px;text-align: center; " valign="top"> 
				...
				<tr>
					<th>
						<h1 style="color:purple;">Guests</h1>
					</th>
				</tr>
 <tr> 
 <td valign="top">
 <div  id="regis"> 
      <c:url var="myAction" value="showGuestList.obj" /> 
           ...
           <tr>
            ...
            <tr>
                <td colspan="2" align='right'>
                    <br><input type="submit" name="action" value="showGuest"  id="sbmt" class='button' style="cursor:url('../\images/88.cur'),default" />
                </td>
