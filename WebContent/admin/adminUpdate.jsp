...
<table background="images/h7.jpg" id="tab">
	...
	<tr>
		...
		<td style="width:400px;height: 600px;text-align: center; " valign="top"> 
				...
				<tr>
					<th>
						<h1 style="color:purple;">Update Hotel Details</h1>
					</th>
				</tr>
 <tr> 
 <td valign="top">
 <div  id="regis"> 
         ...
         <c:url var="myAction" value="UpdateHotelDesc.obj" /> 
        	...
        	<tr><td colspan="2" ><input type="text" name="error" id="errortxt"
        	       value="Enter the Hotel Id and Hotel Description" style="cursor:url('images/88.cur'),default"/></td></tr>
           ...
           <tr>
           	<td>
           		<font color="black">Hotel Description :</font>
           	</td>
           	<td>
           		<TextArea id="txt" type="text" name="desc" style="" ></TextArea>
           	</td>
           </tr>
            <tr>
                <td colspan="2" align='right'>
                    <br><input type="submit" name="action" value="update" id="sbmt" class='button' style="cursor:url('../\images/88.cur'),default" />
                </td>
